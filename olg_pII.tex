...
\begin{figure}[tb]
\centering
	\includegraphics[width=4 in]{fig1_flower.pdf}
...
\begin{figure}
\centering
	\includegraphics[width=3.5 in]{fig2_combiner.pdf}
...
\begin{figure}[tb]
\centering
\includegraphics[width=5 in]{fig3_muxfi.pdf}
...
\begin{figure}[tb]
\centering
\includegraphics[width=5 in]{fig4_comparator.pdf}
	\caption{Simulation result of optical comparator.}
...
Fig.\ref{fig5_adder} presents the half adder simulation results. In this case, Sum=$A'B+AB'$($A\oplus B$) and Carry=\textit {A}.\textit {B}.
   \begin{figure}[tb]
\centering
\includegraphics[width=5 in]{fig5_adder.pdf}
...
There is only one path from the 1$^{st}$ input to the 1$^{st}$ drop port. This is shown in Fig. \ref{fig2a_ID11}.\\
  \begin{figure}[tb]
\centering
\includegraphics[width=3 in]{fig2a_ID11.pdf}
...
\begin{figure}[h!]
  \centering
    ...
    \includegraphics[width=\linewidth]{fig3a_141.pdf}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{fig3a_142.pdf}
    \caption{}
  \end{subfigure}
...
\begin{figure}[h!]
  \centering
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{fig4a_ID131.jpg}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{fig4a_ID132.pdf}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{fig4a_ID133.jpg}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{fig4a_ID134.pdf}
    \caption{}
  \end{subfigure}
